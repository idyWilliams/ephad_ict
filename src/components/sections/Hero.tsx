...
export const Hero = () => {
  return (
    <section className="relative min-h-[100svh] bg-[var(--lm-section)] dark:bg-[var(--dm-base)] text-[var(--lm-text-main)] dark:text-[var(--dm-text-main)] overflow-hidden flex flex-col justify-end pt-32 pb-12 transition-colors duration-500">
