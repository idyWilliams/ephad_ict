...
export const About = () => {
  return (
    <section id="about" className="py-32 bg-[#02040a] relative z-10 overflow-hidden border-t border-white/5">
      ...
      <div className="container mx-auto px-6 md:px-[10%] relative z-20">
        <div className="grid lg:grid-cols-12 gap-16 items-start">
          ...
          >
            ...
            <h3 className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tighter text-white leading-[1.05] uppercase">
              Theory is dead. <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white/70 to-white/20">We build operators.</span>
            </h3>
          ...
          <motion.div
            ...
            className="lg:col-span-4 flex flex-col gap-10 lg:pl-12 border-l border-white/5 lg:py-8"
          >
            {[
              ...
              <motion.div key={i} variants={fadeIn} className="group cursor-default">
                <div className="text-5xl lg:text-6xl font-light text-white group-hover:text-[var(--color-brand-sky)] transition-colors tracking-tighter">
                  {m.val}
                </div>
                <div className="mt-2 text-xs uppercase tracking-[0.2em] font-medium text-white/40">
                  {m.label}
                </div>
              </motion.div>
            ))}
