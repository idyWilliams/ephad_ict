...
export const About = () => {
  return (
    ...
    <section id="about" className="py-32 bg-[var(--lm-base)] dark:bg-[var(--dm-base)] relative z-10 overflow-hidden border-t border-[var(--lm-soft-line)] dark:border-[var(--dm-soft-line)] transition-colors duration-500">
