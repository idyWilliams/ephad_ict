          ...
          <div className="relative z-10 p-12 md:p-20 flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="max-w-2xl">
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[#1C1C18]/60 dark:text-white/60">For Parents & Guardians</span>
              </div>
              <h3 className="text-4xl md:text-5xl font-light text-[#1C1C18] dark:text-white tracking-tight leading-[1.1] mb-6">
                Discover the <span className="font-bold">Youth Academy.</span>
              </h3>
              <p className="text-lg text-[#1C1C18]/60 dark:text-white/60 font-light leading-relaxed">
            ...
            <div className="flex-shrink-0">
              <Link 
                href="/kids-teens"
                className="group/btn relative inline-flex items-center justify-center gap-4 h-16 px-10 bg-[#1C1C18] dark:bg-white text-white dark:text-[#1C1C18] font-bold text-sm uppercase tracking-widest overflow-hidden transition-all hover:scale-[1.02]"
              >
